...
**결제 도메인 프론트엔드 개발자 · 4년차**

네이버페이 사업자금융팀에 상주하며 사업자 결제·환급금 조회·정책지원금 안내·사업백과사전 등 NpayBiz 서비스 개발·운영을 담당하고 있습니다.
...
**Domain** — 결제/핀테크, BFF 아키텍처 기반 멀티 환경 프론트엔드 개발

---

### 📂 정리한 저장소

실무에서 마주친 문제를 익명화해 다시 정리한 기록입니다. **문제 상황 → 해결 방법 → 그 방법을 선택한 이유** 구조로 재구성했습니다.
